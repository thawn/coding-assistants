...
\begin{frame}
  ...
  \begin{itemize}
    \item GitHub Copilot (integrated into GitHub as well as IDE plugin)
    \item Opencode (CLI, IDE plugin, GitHub/GitLab CI)
    \item Cursor (stand alone IDE)
  \end{itemize}
\end{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.7\textwidth}
      ...
      \begin{itemize}
        ...
        \item The environment should be safe to execute commands (e.g. a virtual machine)
